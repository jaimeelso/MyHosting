##
 ...
 #
 # Version 1.0 Sync CodeCommit with S3 and invalidate CloudFront cache
 #
 # Description: Sync CodeCommit with S3 and invalidate CloudFront cache
##
...
def lambda_handler(event, context):
	...
	# Declare three arrays to group the updated, deleted and invalidated files
	updatedFiles = []
	deletedFiles = []
	invalidateFiles = []

	# Populate the arrays using list comprehension
	...
	print('Invalidate files: ')
	print(invalidateFiles)
